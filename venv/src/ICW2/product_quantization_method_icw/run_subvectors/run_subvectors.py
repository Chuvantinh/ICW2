...
optics = OPTICS(min_samples=10, xi=.05, min_cluster_size=.05, n_jobs=-1).fit(X)
...
print('###############################################')
total_labels = kmeans.labels_ + kmeans2.labels_ + kmeans3.labels_ + labels_MiniBatchKMeans
...
print('differences_element',len(total_labels) - len(same_element))
